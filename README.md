...
- 🎧  [FestivApp](https://github.com/fchapoulliep/FestivApp), an open source application for tracking festivals in mainland France
- 🧬 [DiagnoSphere](), A medical monitoring application intended for research purposes
